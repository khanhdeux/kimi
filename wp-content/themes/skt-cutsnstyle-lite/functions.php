...
define('SKT_URL','http://www.sktthemes.net','skt-cutsnstyle-lite');
define('SKT_THEME_URL','http://www.sktthemes.net/themes/','skt-cutsnstyle-lite');
define('SKT_THEME_DOC','http://sktthemesdemo.net/documentation/skt-cutnstyle-doc/','skt-cutsnstyle-lite');
define('SKT_PRO_THEME_URL','http://www.sktthemes.net/shop/cutsnstyle/','skt-cutsnstyle-lite');
define('SKT_PRO_FONT_AWESOME_URL','http://fortawesome.github.io/Font-Awesome/icons/','skt-cutsnstyle-lite');
define('SKT_FREE_THEME_URL','http://www.sktthemes.net/product-category/free-wordpress-themes/','skt-cutsnstyle-lite');
